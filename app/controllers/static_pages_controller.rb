class StaticPagesController < ApplicationController
  def home
     ...
     @completed_workorders=Workorder.wo_current_branch(current_user.current_branch).wo_completed.descending.paginate(page: params[:page], :per_page => 5) if signed_in?
